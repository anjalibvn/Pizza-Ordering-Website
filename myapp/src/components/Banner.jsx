...
export const Banner=()=>{
    return(
        <div className="banner w-full md:w-2/3 px-auto relative flex items-center-justify-between">
    ...
    <div className="btn-container">
        ...
        <a href="/menu" className="text-yellow-400 hover:text-yellow-500 font-bold text-decoration-line px-3">
            ...
            <div className="banner-image w-full md:w-1/2 p-3 flex justify-end">
                <img src={require("../assets/images/pizza_banner.png")} alt="banner" className="max-h-95"></img>
                </div>
